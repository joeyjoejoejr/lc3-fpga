...
test-interrupt: $(BUILD)/lc3_interrupt_tb.vvp
	@$(RUN_VVP) $<
...
test-keyboard-interrupt: $(BUILD)/lc3_keyboard_interrupt_tb.vvp
	@$(RUN_VVP) $<
...
$(BUILD)/lc3_interrupt_tb.vvp: $(RTL) tb/lc3_interrupt_tb.sv tb/tb_helpers.svh
	@mkdir -p $(BUILD)
	@$(IVERILOG) $(IVERILOG_FLAGS) -I tb -o $@ tb/lc3_interrupt_tb.sv $(RTL)
...
$(BUILD)/lc3_keyboard_interrupt_tb.vvp: $(MEMCTL_RTL) tb/lc3_keyboard_interrupt_tb.sv tb/tb_helpers.svh
	@mkdir -p $(BUILD)
	@$(IVERILOG) $(IVERILOG_FLAGS) -I tb -o $@ tb/lc3_keyboard_interrupt_tb.sv $(MEMCTL_RTL)
